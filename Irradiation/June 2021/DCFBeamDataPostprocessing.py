...
currentThreshold = 0.000004 # adjust this after running the script once and looking at the current coming into the stage
...
pathToFiles = 'C:/Users/apcwy/OneDrive - Massachusetts Institute of Technology/Physics PhD/DCF/Jan 2020/Beam Data DCF/'
filenames = [ "2020-01-28 Angus Protons.txt",
              "2020-01-29 Angus Protons.txt",
              "2020-01-30 Angus Protons edited.txt",
...
for i in range(len(timeArr)):
    if (currStageArr[i]>currentThreshold):
        ...
        fluxArr = np.append(fluxArr, currStageArr[i]/(areaOfIrradiation*incidentIonIonisation*1.6E-19))
...
print("Average ion flux: ", totalCharge/(timeBeamWasOn*areaOfIrradiation*incidentIonIonisation*1.6E-19)," +-", np.std(fluxArr), "m\u207B\u00B2s\u207B\u00B9")
print("alternative flux check: ", np.average(fluxArr))
